-- Create a view that aggregates lead timeline data from multiple sources
...
-- Add RLS-compatible function to get timeline for a lead
-- Note: Views inherit RLS from underlying tables, but we add explicit security
COMMENT ON VIEW lead_timeline IS 'Aggregated timeline of all lead activities including notes, calls, demos, and follow-ups';