      ...
      <main className="max-w-7xl mx-auto px-4 py-8 md:py-12 -mt-4">
        <div className="grid lg:grid-cols-5 gap-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <span className="font-medium text-foreground">Try the AI Phone Assistant</span> — Call the demo hotline and enter your passcode (the last 4 digits of your mobile phone number){demo.passcode ? ` — ${demo.passcode}` : ''}.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <span className="font-medium text-foreground">Follow Up With Us</span> — Ready to chat? Book a time on the calendar below, or reach out to John Stevens from the EverLaunch team directly.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {/* Calendar Section - Mobile/Tablet only */}
            <div className="lg:hidden">
              <Card className="shadow-xl border-0">
                <CardHeader className="border-b bg-muted/30">
                  <div className="flex items-center justify-between">
