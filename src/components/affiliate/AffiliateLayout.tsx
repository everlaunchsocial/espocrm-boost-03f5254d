...
const affiliateNavigation = [
  ...
  { name: 'Estimates', href: '/affiliate/estimates', icon: FileText },
  { name: 'Invoices', href: '/affiliate/invoices', icon: Receipt },
  { name: 'Tasks', href: '/affiliate/tasks', icon: CheckSquare },
  { name: 'Media Library', href: '/affiliate/media-library', icon: FolderOpen },
